    ...
    .directive('youtubeVideo', ['youtubeEmbedUtils', function(youtubeEmbedUtils) {
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                function applyBroadcast(eventname, player, event) {
                    //gets things that applyBroacast was called with,
                    //turns it into real array

                    var args = [].slice.call(arguments);

                    scope.$apply(function() {
                        // console.log("emit apply", scope.$emit)

                        //calls emit with the scope as the 'this' value
                ...
                function onPlayerStateChange(event) {
                    ...
                    //calling apply as we are outside digest cycle
                    scope.$apply(function() {
                ...
                var stopWatchingReady = scope.$watch(
                    function() {
                        return scope.utils.ready
                            ...
                            && (typeof scope.videoUrl !== 'undefined' || typeof scope.videoId !== 'undefined');
                    },
                    function(ready) {
                        if (ready) {
                            stopWatchingReady();
